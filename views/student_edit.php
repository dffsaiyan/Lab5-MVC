               ...
               <div class="col-md-8 col-lg-6">
                    ...
                    <div class="card">
                         ...
                         <div class="card-body p-4">
                              <form action="index.php?page=student-update" method="POST">
                                   <!-- Hidden ID -->
                                   ...
                                   <div class="mb-3">
                                        ...
                                        <input type="tel" class="form-control form-control-lg" id="phone" name="phone"
                                             ...
                                             value="<?= htmlspecialchars($_SESSION['old']['phone'] ?? $student['phone']) ?>">
                                   </div>
                                   ...
                                   <div class="mb-4">
                                        ...
                                        <textarea class="form-control" id="address" name="address" rows="3"
                                             placeholder="Nhập địa chỉ sinh viên..."><?= htmlspecialchars($_SESSION['old']['address'] ?? $student['address']) ?></textarea>
                                   </div>
