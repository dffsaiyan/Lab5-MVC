               ...
               <div class="col-md-8 col-lg-6">
                    ...
                    <div class="card">
                         <div class="card-header bg-success text-white">
                              <h5 class="mb-0"><i class="bi bi-pencil-square"></i> Thông tin sản phẩm</h5>
                         </div>
                              ...
                              <form action="index.php?page=product-store" method="POST">
                                   ...
                                   <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="description" name="description" rows="4"
                                             placeholder="Nhập mô tả sản phẩm..."><?= htmlspecialchars($_SESSION['old']['description'] ?? '') ?></textarea>
                                   </div>
                                   ...
                                   <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="image" name="image"
                                             ...
                                             value="<?= htmlspecialchars($_SESSION['old']['image'] ?? '') ?>">
